...
public class FollowingsFriendListAdapter extends RecyclerView.Adapter<FollowingsFriendListAdapter.ViewHolder> {

    private Context rootContext;
    private List<Friend> listFriendRequest;

    public FollowingsFriendListAdapter(Context rootContext) {
        this.rootContext = rootContext;
    }

    public FollowingsFriendListAdapter(Context rootContext, List<Friend> listFriendRequest) {
        this.rootContext = rootContext;
