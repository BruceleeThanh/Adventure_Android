...
public class TagsEditText extends AutoCompleteTextView {
    ...
    private void init(@Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        if (attrs == null) {
            ...
            mTagsTextColor = getColor(context, R.color.primary_text);
            mTagsTextSize = ResourceUtils.getDimensionPixelSize(context, R.dimen.txt_small_medium);
            mTagsBackground = ContextCompat.getDrawable(context, R.drawable.bg_tags_edit_text);
            mRightDrawable = ContextCompat.getDrawable(context, R.drawable.ic_clear_grey_600_18dp);
            mDrawablePadding = ResourceUtils.getDimensionPixelSize(context, R.dimen.margin_small);
            mTagsPaddingRight = ResourceUtils.getDimensionPixelSize(context, R.dimen.margin_small);
            mTagsPaddingLeft = ResourceUtils.getDimensionPixelSize(context, R.dimen.margin_small);
            mTagsPaddingTop = ResourceUtils.getDimensionPixelSize(context, R.dimen.margin_small);
            mTagsPaddingBottom = ResourceUtils.getDimensionPixelSize(context, R.dimen.margin_small);
        } else {
            ...
            try {
                ...
                mTagsTextSize = typedArray.getDimensionPixelSize(R.styleable.TagsEditText_tagsTextSize,
                        ResourceUtils.getDimensionPixelSize(context, R.dimen.txt_small_medium));
                ...
                mDrawablePadding = typedArray.getDimensionPixelOffset(R.styleable.TagsEditText_tagsCloseImagePadding,
                        ResourceUtils.getDimensionPixelSize(context, R.dimen.margin_small));
