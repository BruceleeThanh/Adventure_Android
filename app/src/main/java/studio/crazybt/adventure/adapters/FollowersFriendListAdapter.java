...
public class FollowersFriendListAdapter extends RecyclerView.Adapter<FollowersFriendListAdapter.ViewHolder> {

    private Context rootContext;
    private List<Friend> listFriendRequest;

    public FollowersFriendListAdapter(Context rootContext) {
        this.rootContext = rootContext;
    }

    public FollowersFriendListAdapter(Context rootContext, List<Friend> listFriendRequest) {
        this.rootContext = rootContext;
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            btnRightFriendTemplate.setText(rootContext.getString(R.string.cancel_follow_btn_friend_and_follow));
        }
    }
}
